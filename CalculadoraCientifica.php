        ...
        ?>
         <form action='#' method='post' name='calculadora'>
                ...
                <div class='calculadora'>
                     <?php       
                    echo "<input type='text' id='pantalla' name='expresion' value='{$_SESSION['calculadoraCientifica']->getPantalla()}' readonly/>";
                        ?>
                            ...
                            <input type = 'submit' id='delete' name = 'borrar' value = 'Del'/>
